...
public:
	...
	AZodiacHostCharacter* GetHostCharacterFromActorInfo() const;
	...
	virtual void SetCameraMode(TSubclassOf<UZodiacCameraMode> CameraMode) override;
	virtual void ClearCameraMode() override;
