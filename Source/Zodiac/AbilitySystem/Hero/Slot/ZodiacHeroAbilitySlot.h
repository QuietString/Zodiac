...
UCLASS()
class UZodiacAbilitySlotFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

	UFUNCTION(BlueprintCallable, meta=(DeterminesOutputType=FragmentClass))
	static const UZodiacHeroAbilityFragment* FindAbilityFragment(UZodiacHeroAbilitySlot* Slot, TSubclassOf<UZodiacHeroAbilityFragment> FragmentClass);
};