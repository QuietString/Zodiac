...
protected:
	...
	/** Notify the client that an ability failed to activate */
	...
	// Add a local gameplay tag for a given duration from an ability. The duration will last even after the ability ends.
	UFUNCTION(BlueprintCallable)
