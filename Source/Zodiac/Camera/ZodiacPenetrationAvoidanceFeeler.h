...
#include "ZodiacPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FZodiacPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FZodiacPenetrationAvoidanceFeeler()
	...
	FZodiacPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
