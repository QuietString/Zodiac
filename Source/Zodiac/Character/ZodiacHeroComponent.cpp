...
TArray<FName> UZodiacHeroComponent::GetCurrentSkillSockets(const FGameplayTag InSkillID)
{
	if (HeroData->SocketData.Find(InSkillID))
	{
		return HeroData->SocketData[InSkillID].TraceSockets;
	}
