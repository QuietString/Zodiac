...
#include "ZodiacCharacterPartTypes.generated.h"

class UChildActorComponent;
class UZodiacPawnComponent_CharacterParts;
...
struct FZodiacCharacterPartHandle
{
	GENERATED_BODY()
...
struct FZodiacCharacterPart
{
	...
	static bool AreEquivalentParts(const FZodiacCharacterPart& A, const FZodiacCharacterPart& B)
	{
