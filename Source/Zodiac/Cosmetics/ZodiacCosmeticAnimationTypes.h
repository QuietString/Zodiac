...
#include "ZodiacCosmeticAnimationTypes.generated.h"
...
struct FZodiacAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FZodiacAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FZodiacAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FZodiacAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FZodiacAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FZodiacAnimBodyStyleSelectionEntry> MeshRules;
