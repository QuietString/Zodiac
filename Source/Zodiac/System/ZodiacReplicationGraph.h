...
DECLARE_LOG_CATEGORY_EXTERN(LogZodiacRepGraph, Display, All);

/** Zodiac Replication Graph implementation. See additional notes in ZodiacReplicationGraph.cpp! */
...
private:
	...
	/** Classes that had their replication settings explictly set by code in UZodiacReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class UZodiacReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class UZodiacReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
