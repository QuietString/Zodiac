...
#include "SceneView.h"
#include "UI/IndicatorSystem/ZodiacIndicatorManagerComponent.h"
...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UZodiacIndicatorManagerComponent* InManager)
{
...
{
	if (UZodiacIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
