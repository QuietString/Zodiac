...
class ZODIAC_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UZodiacIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UZodiacIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UZodiacIndicatorManagerComponent> ManagerPtr;
