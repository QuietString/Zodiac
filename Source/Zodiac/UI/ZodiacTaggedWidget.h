...
#include "ZodiacTaggedWidget.generated.h"
...
class UZodiacTaggedWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UZodiacTaggedWidget(const FObjectInitializer& ObjectInitializer);
