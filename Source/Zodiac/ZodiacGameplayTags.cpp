...
FZodiacGameplayTags FZodiacGameplayTags::GameplayTags;

void FZodiacGameplayTags::InitializeNativeTags()
{
...
FGameplayTag FZodiacGameplayTags::FindTagByString(const FString& TagString, const bool bMatchPartialString)
{
...
void FZodiacGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
	...
	AddTag(Effect_Test, "Effect.Test", "Test effect such as on fire");
...
void FZodiacGameplayTags::AddTag(FGameplayTag& OutTag, const ANSICHAR* TagName, const ANSICHAR* TagComment)
{
	OutTag = UGameplayTagsManager::Get().AddNativeGameplayTag(FName(TagName), FString(TEXT("(Native) ")) + FString(TagComment));
}

void FZodiacGameplayTags::AddMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName, uint8 MovementMode)
{
	AddTag(OutTag, TagName, "Character movement mode tag.");
	GameplayTags.MovementModeTagMap.Add(MovementMode, OutTag);
}

void FZodiacGameplayTags::AddCustomMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName,
